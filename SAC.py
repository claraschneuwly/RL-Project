...
class SAC:
    ...
    def train(self):
        ...
        for global_step in range(self.args.total_timesteps):
            ...
            if global_step > self.args.learning_starts:
                ...
                self.update_parameters(data, global_step, start_time)
    ...
    def update_parameters(self, data, global_step, start_time):
        # Update Q functions
        with torch.no_grad():
            ...
            next_q_value = data[3].flatten() + (1 - data[4].flatten()) * self.args.gamma * min_qf_next_target.view(-1)
